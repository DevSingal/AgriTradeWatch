export const en = {
  ...
  map: {
    ...
    to: "to",
    reports: "reports",
    dragPinTip: "💡 Drag the blue pin to explore different areas",
    dragPinInstruction: "💡 Drag the blue pin to explore different areas",
  ...
  damageCrop: {
    ...
    damageAmount: "Damage Qty/Area",
    enterDamageAmount: "Enter damage quantity or area",
    ...
    addPhoto: "Add Photo *",
    addPhotoMessage: "Photo is required to verify the damage",
    takePhoto: "Take Photo",
    fromGallery: "From Gallery",
    photoAttached: "📎 {{fileName}}",
